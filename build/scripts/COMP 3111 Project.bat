...
@rem ##########################################################################
@rem
@rem  COMP 3111 Project startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and COMP_3111_PROJECT_OPTS to pass JVM options to this script.
...
@rem Execute COMP 3111 Project
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %COMP_3111_PROJECT_OPTS%  -classpath "%CLASSPATH%" comp3111.webscraper.WebScraperApplication %CMD_LINE_ARGS%
...
:fail
rem Set variable COMP_3111_PROJECT_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%COMP_3111_PROJECT_EXIT_CONSOLE%" exit 1
exit /b 1
